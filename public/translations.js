export const translations = {
    ...
    en: {
        ...
        info_body_title: "1. Body & Paint", info_body_desc: "Precise paint thickness measurement (detecting putty and second layers). Assessment of panel gaps, glass originality, tire and rim condition, and search for disassembly traces.",
        info_eng_title: "2. Engine & Components", info_eng_desc: "Cold and warm engine operation analysis. Verification of leaks, injector performance, turbocharger operation, accessory belt, and exhaust smoke.",
        info_drive_title: "3. Drivetrain & Suspension", info_drive_desc: "Gearbox operation test (smoothness, jerking). Assessment of brakes (discs/pads), shock absorbers, steering play, and suspension noise.",
        info_int_title: "4. Interior & Equipment", info_int_desc: "Wear verification (steering wheel, seats) versus mileage. Testing all electronics, air conditioning, audio systems, and searching for moisture/flood traces.",
    ...
    nl: {
        ...
        hero_cta_desc: "Vertrouw op de experts. Bespaar tijd en geld.",
        hero_btn: "BEKIJK PRIJZEN",

        info_title: "WAT CONTROLEREN WIJ PRECIES?",
        info_body_title: "1. Carrosserie & Lak", info_body_desc: "Nauwkeurige lakdiktemeting (detectie van plamuur en tweede laklaag). Beoordeling van paneelnaden, originaliteit van glas, staat van banden en velgen, en zoeken naar demontagesporen.",
        info_eng_title: "2. Motor & Onderdelen", info_eng_desc: "Analyse van de motorwerking (koud en warm). Controle op lekkages, werking van injectoren, turbo, multiriem en rook uit het uitlaatsysteem.",
        info_drive_title: "3. Aandrijving & Ophanging", info_drive_desc: "Test van de versnellingsbak (soepelheid, schokken). Beoordeling van remmen (schijven/blokken), schokdempers, stuurspeling en bijgeluiden.",
        info_int_title: "4. Interieur & Uitrusting", info_int_desc: "Slijtagecontrole (stuur, stoelen) ten opzichte van de kilometerstand. Testen van alle elektronica, airconditioning, audiosystemen en zoeken naar sporen van vocht/waterschade.",
